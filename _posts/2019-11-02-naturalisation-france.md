...
<img src="/assets/images/2019/11/nombre_naturalisation.png" width="800px" />
...
- **归化公布日期**是归化法令公布在政府公报的日期。一般来说归法法令在政府签字后的 2 天后才会公布，尽管在法律上是签字后就生效。
...
[^3]: 看来制定归法序号的也是用 C++ 和 Python 的，用 0 而不是 1 作为序列的第一位。
